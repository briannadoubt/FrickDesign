...
public enum FrickTokens {
    ...
    public enum Colors {
        ...
        public static let success = Color.frickDynamic(light: FrickColorComponents(red: 0.0627, green: 0.4784, blue: 0.3569), dark: FrickColorComponents(red: 0.3294, green: 0.8471, blue: 0.6745))
        public static let warning = Color.frickDynamic(light: FrickColorComponents(red: 0.5412, green: 0.3529, blue: 0.0000), dark: FrickColorComponents(red: 0.8863, green: 0.7137, blue: 0.3608))
        public static let danger = Color.frickDynamic(light: FrickColorComponents(red: 0.6196, green: 0.2000, blue: 0.3098), dark: FrickColorComponents(red: 1.0000, green: 0.5412, blue: 0.6392))
        public static let info = Color.frickDynamic(light: FrickColorComponents(red: 0.2549, green: 0.4118, blue: 0.7686), dark: FrickColorComponents(red: 0.4902, green: 0.6353, blue: 1.0000))
